...
fab1bt = [0.58, 0.62, 0.67, 0.74];
fab2bt = [1.11, 1.20, 1.03, 0.82];
fab4bt = [2.19, 1.30, 1.04, 0.95];
fab8bt = [2.38, 1.53, 1.09, 0.97];

besu1bt = [0.56, 0.61, 0.7, 1.02];
besu2bt = [1.12, 1.77, 1.82, 2.33];
besu4bt = [2.99, 3.8, 4.17, 3.7];
besu8bt = [6.87, 6.26, 7.39, 6.13];
...
title('Latency for varying block times')
