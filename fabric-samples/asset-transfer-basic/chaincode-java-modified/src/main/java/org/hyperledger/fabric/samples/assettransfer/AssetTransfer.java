...
public final class AssetTransfer implements ContractInterface {
    ...
    public Asset CreateAsset(final Context ctx, final String assetID, final String color, final int size,
        ...
        // NOTE: Changes are made in this function on the line below!
        if (ctx.getClientIdentity() != null &&
                ctx.getClientIdentity().getId().equalsIgnoreCase("SomeCompetingOrg")) {
            throw new ChaincodeException("Competing Org will not be served!",
